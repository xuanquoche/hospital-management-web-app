...
export function PatientTable({ patients, selectedPatientId, onSelectPatient }: PatientTableProps) {
  return (
                ...
                <TableCell>
                  <div className="flex items-center gap-2">
                    ...
                    {patient.tags.map((tag) => (
                      <Badge key={tag} variant="outline" className="rounded-full font-normal text-muted-foreground border-transparent bg-muted/50">
                        {tag}
                      </Badge>
                    ))}
                  </div>
