      ...
      <div className="bg-muted/50 inline-flex h-9 items-center justify-center rounded-lg p-1 text-muted-foreground">
        <button
          ...
          className={cn(
            ...
            activeTab === 'all' ? "bg-emerald-600 text-white shadow-sm" : "hover:bg-background/50 hover:text-foreground"
          )}
        >
          Tất cả
        </button>
        <button
          ...
          className={cn(
            "inline-flex items-center justify-center whitespace-nowrap rounded-md px-3 py-1 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
            activeTab === 'active' ? "bg-emerald-600 text-white shadow-sm" : "hover:bg-background/50 hover:text-foreground"
          )}
        >
          Đang hoạt động
        </button>
        <button
          ...
          className={cn(
            "inline-flex items-center justify-center whitespace-nowrap rounded-md px-3 py-1 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
            activeTab === 'inactive' ? "bg-emerald-600 text-white shadow-sm" : "hover:bg-background/50 hover:text-foreground"
          )}
        >
          Không hoạt động
        </button>
