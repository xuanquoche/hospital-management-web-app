...
export const PersonalInfoCard = ({ info }: PersonalInfoCardProps) => {
  return (
    <div className='bg-white rounded-2xl p-6 shadow-sm border border-slate-100 mb-6'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-y-3 text-sm'>
        <div className='flex justify-between md:justify-start md:gap-12'>
          ...
          <span className='font-medium text-slate-900'>Nữ</span>
        </div>
        <div className='flex justify-between md:justify-start md:gap-12'>
          <span className='text-slate-500 w-24'>Ngày sinh</span>
          <span className='font-medium text-slate-900'>05/03/1992</span>
        </div>
        <div className='flex justify-between md:justify-start md:gap-12'>
