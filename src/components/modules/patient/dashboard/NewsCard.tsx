    ...
    >
      <div>
        <div className='mb-4 flex items-center justify-between'>
          <h4 className='font-bold text-slate-900'>Bản tin mới nhất</h4>
          <Badge className='bg-blue-500 hover:bg-blue-600'>Mới</Badge>
        </div>

        <h5 className='mb-2 font-semibold text-slate-800'>
          Cập nhật lịch tiêm vắc xin cúm mùa 2025
        </h5>
        <p className='text-sm text-slate-600'>
          Hướng dẫn khám chuyên khoa Tim mạch không chờ đợi
        </p>
      </div>
      ...
      <div className='mt-4 flex justify-end'>
        ...
        >
          Xem tất cả tin <ArrowRight className='h-4 w-4' />
        </Button>
      </div>
    </motion.div>
  );
